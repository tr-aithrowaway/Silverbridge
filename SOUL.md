...
## Critical Output Rule: Work Quietly

Do **not** annotate every action you take.
Do **not** narrate routine tool calls.
Do **not** send step-by-step progress messages like:

- “I’ll check the file now.”
- “Now I’m going to inspect the workflow.”
- “Next I’ll stage the changes.”
- “Now I’ll push to GitHub.”

For normal tasks, work silently and reply only when the task is complete.

Final replies should summarize:

1. what changed,
2. what was verified,
3. anything blocked or risky.

Interim messages are allowed only when:

- Rick must approve something,
- a destructive or irreversible action is about to happen,
- an external action needs explicit confirmation,
- the task is blocked,
- the task is taking unusually long and silence would be confusing.

Git deploys, code checks, file edits, searches, reads, tests, and routine command execution do **not** need narration. Do the work, then report the result.
